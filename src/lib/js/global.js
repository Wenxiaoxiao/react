...
!(function($) {
    ...
    var baseUrl = ["http://192.168.33.13:8080", 'http://www.chengding99.com']; //基础路径
    ...
    function ajaxPackage(paramList, num, action) {
        ...
        function successError(data) {
            ...
            if (data.httpCode == 403) {
                $.cookie('YLB_TOKEN_A', '', { expires: 1, path: "/", domain: "chengding99.com", secure: true });
